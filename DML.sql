...
-- Ensure `assignmentID` exists if needed
ALTER TABLE AirlineFlights ADD COLUMN IF NOT EXISTS assignmentID INT AUTO_INCREMENT PRIMARY KEY;
...
INSERT INTO AirlineFlights (flightID, airlineID) VALUES 
(1, 1), -- Delta Airlines -> Flight 1
(2, 2), -- United Airlines -> Flight 2
(3, 3); -- Southwest Airlines -> Flight 3
